    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (isThereProblemBeforeProcessing) {
                res.sendRedirect(Global.DEFAULT_PAGE.substring(1));
            } else if (uri.indexOf(req.getContextPath() + Global.DEFAULT_PAGE) >= 0
                    || (ses != null /*&& ses.getAttribute(Global.SESSION_USERNAME) != null*/)
